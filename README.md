# BIEVR-LIO to HDMapping simplified instruction
...
```shell
cd ~/hdmapping-benchmark/benchmark-BIEVR-LIO-to-HDMapping
...
You should see the following data in folder `~/hdmapping-benchmark/data/output_hdmapping-BIEVR-LIO`:
